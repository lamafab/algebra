...
--
-- TODO: Expand on Schwartz–Zippel lemma.
...
-- ============================================================================
--
-- Fix a finite multiplicative subgroup H of a field. For concreteness, take
-- the n-th roots of unity ⟨ω⟩ = {1, ω, …, ωⁿ⁻¹} inside 𝔽ₚˣ (RootsOfUnity.lean §2).
-- The polynomial that vanishes on H and only on H is the vanishing polynomial,
-- also called the zerofier:
--
--   Z_H(X) = ∏_{h ∈ H} (X − h).
--
