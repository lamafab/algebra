...
--
-- 4 is NOT a generator: 4¹ = 4, 4² = 1, 4³ = 4, 4⁴ = 1, … its powers flip
-- between 1 and 4, so it only generates {1, 4}, not the whole 𝔽₅ˣ. The order
-- of an element is the smallest k > 0 with gᵏ = 1; here the first return to 1
-- happens at k = 2, so the order is 2, not 4.
